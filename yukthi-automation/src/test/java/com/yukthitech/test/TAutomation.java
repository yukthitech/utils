...
public class TAutomation
{
	...
	{
		AutomationLauncher.main(new String[] {"./src/test/resources/app-configuration.xml", "-rf", "./output", "-prop", "./src/test/resources/app.properties", "-ts", "load-resources-test-suites"});
