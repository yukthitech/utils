...
@FieldBooster(field = "value")
public class TestBeanSearchQueryWithBoost
{
	...
	public TestBeanSearchQueryWithBoost(String name, String text, List<String> keys, Integer value)
	{
		this.name = name;
		this.text = text;
		this.keys = keys;
