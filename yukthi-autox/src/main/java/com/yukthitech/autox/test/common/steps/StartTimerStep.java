 ...
 * @author akiran
 */
@Executable(name = "startTimer", message = "Starts time tracking with specified name. Stopping timer would keep elaspsed time on context which can used for logging.")
