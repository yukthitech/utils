 ...
 * @author akiran
 */
@Executable(name = {"uiGotoUrl"}, requiredPluginTypes = SeleniumPlugin.class, message = "Loads page with specified url")
public class GotoUrlStep extends AbstractStep
{
	...
	{
		exeLogger.debug(this, "Going to page with url - {}", url);
