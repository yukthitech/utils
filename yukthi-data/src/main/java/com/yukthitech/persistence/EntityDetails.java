...
public class EntityDetails
{
	...
	{
		this(tableName, entityType, null);
	}
	
	public EntityDetails(String tableName, Class<?> entityType, String simpleName)
	{
		...
		simpleName = (simpleName == null) ? entityType.getSimpleName() : simpleName;
	}
