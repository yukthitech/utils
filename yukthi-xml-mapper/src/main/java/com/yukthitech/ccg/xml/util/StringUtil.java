...
import com.yukthitech.utils.ArrayIterator;
...
public class StringUtil
{
	 ...
	 * @param delimiter
	 *            Delimiter(s) to be used for tokenizing.
	 * @param includeDelimiter
	 *            Whether the result array should include delimiters.
	 * @param emptyTokens
	 *            Whether the result should include empty tokens.
	...
	public static String[] tokenize(String str, String delimiter, boolean includeDelimiter, boolean emptyTokens, boolean trim)
	{
		...
		String token = null;
		boolean delimFlag = true;// represents whether previous token is
									// delimiter
	...
	/**
	 * Tokenizes str into string array using "delimiter" as delimiter. But in
	 * this version an escape character can be specified. Any character
	 * preceeded by specified escape character (including delimiter and escape
	 * character itself) that character will get simply gets appended to the
	 * previous token(if any, otherwise gets prepended to the next token). If
	 * escape char is specified at the end of the str, it will get simply
	 * ignored. <BR>
	 * 
	 * @param str
	 *            String to be tokenized.
	 * @param delimiter
	 *            Delimiter to be used for tokenizing.
	 * @param includeDelimiter
	 *            Specified whether delimiters should be included in result
	 *            array.
	 * @param emptyTokens
	 *            Specified whether result should include empty tokens.
	 * @param esc
	 *            Escape character to be used.
	...
	public static String[] tokenize(String str, String delimiter, boolean includeDelimiter, boolean emptyTokens, char esc)
	{
		...
		while(st.hasMoreTokens())
		{
			 ...
			 * next token escape char, delimiter or normal char string attach it
	 ...
	 * 
	 * @param str
	 *            String in which replacement should happen.
	 * @param src
	 *            Source string to be replaced in str.
	 * @param dst
	 *            Destination replacement string.
	...
	{
		return joingString(new ArrayIterator(arr), delim, null, null);
	}
	...
	{
		return joingString(new ArrayIterator(arr), delim, start, end);
	}
